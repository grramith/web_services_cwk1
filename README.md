...
**API Documentation:** [api_documentation.pdf](docs/api_documentation.pdf)
...
> **Submitted PDF documentation** is available in the [`docs/`](docs/) folder as [`api_documentation.pdf`](docs/api_documentation.pdf)
---
