...
| AI enrichment | OpenAI GPT-4o-mini | Optional; all endpoints degrade gracefully if key is absent |
...
> **Note:** If `OPENAI_API_KEY` is not set, all AI endpoints still work — they return deterministic analytics-based output instead of LLM-enriched text.
